...
The `silk::find_outliers()` functions takes a data.frame and a column name as input, and returns a modified version of the input data.frame, which includes columns for median, MAD and a logical column to indicate outliers.
